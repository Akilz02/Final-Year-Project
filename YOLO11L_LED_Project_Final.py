...
class YOLOApp:
    def __init__(self, root, model_path):
        ...
        self.stop_btn.grid(row=0, column=1, padx=25)
    ...
    def start_detection(self):
        ...
        self.status_label.config(text="Status: Detecting...", fg="#61dafb")
    ...
    def video_loop(self):
        while self.video_running:
            ...
            if not ret:
                self.root.after(0, lambda: messagebox.showerror("Error", "Lost webcam connection."))
